package com.example.myappmlkitvisionapi2023;
        ...
        OnFailureListener
{
    ...
    //Estos es para los permisos, la ventanita
    @Override
    ...
    //deteccion de rostro , detecta y dice cuantos hay
                ...
                .addOnSuccessListener(new OnSuccessListener<List<Face>>() {
                    ...
                    public void onSuccess(List<Face> faces) {
                        ...
                        for (Face face:faces){
                            //PintarLineas
                            //Punto x
                            //Pintar lo rectangulos a las caras
